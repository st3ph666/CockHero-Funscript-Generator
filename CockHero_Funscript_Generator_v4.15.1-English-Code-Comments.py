...
# Search window for previous cycles.
LOOKBACK_SECONDS = 10

# Acceptable duration of a complete cycle.
MIN_CYCLE_MS = 180
MAX_CYCLE_MS = 6000

# Maximum number of recent cycles used to fill a gap.
...
# Dynamic amplification of small added movements.
MIN_FILL_RANGE = 50
FILL_MIN_POS = 5
FILL_MAX_POS = 95

# Fallback movement when no cycle is detected.
# IMPORTANT: disabled to prevent creating the red 10 ↔ 90 blocks.
STEP_MS = 120
LOW = 10
HIGH = 90
...
# Progressive start: only the first real cycle.
...
# Smooth transitions at the beginning and end of dead-time gaps.
...
def process_file(input_path, filename):
    ...
    # Remove repetitive red blocks before any new processing.
    actions, removed_fallback_points = remove_old_fallback_runs(actions)

    # Ignore isolated points preceding the first real movement group.
    ...
    # Apply a single continuous progression to the first original block.
...
# CockHero project: visual analysis only.
...
# ============================================================
# 12 FIXED AMPLITUDE PRESETS PER EPISODE
# ============================================================
_EPISODE_AMPLITUDES = [
...
# Independent patterns for the end of the video.
...
# Complete funscript generation from video only.
...
# Common final control for optimized and generated scripts.
CUSTOM_END_FADE_DURATION_MS = 10000
CUSTOM_END_TARGET_POS = 50
CUSTOM_END_HOLD_MS = 0

# CockHero mode: BPM-based rhythmic generation.
COCKHERO_BPM = 120.0
...
class FunscriptGUI(tk.Tk):
    def __init__(self):
        ...
        self.language_var = tk.StringVar(value=self.saved_config.get("language", "Français"))
        ...
        self._build_ui()
        self.after(150, self._apply_language)
    ...
    # ============================================================
    # v4.15.0 — INTERFACE BILINGUE FRANÇAIS / ENGLISH
    # ============================================================
    _EN_EXACT = {
        "Langue :": "Language:", "Mode": "Mode", "Fichier": "File",
        "Ouvrir un funscript": "Open a funscript", "Ouvrir une vidéo": "Open a video",
        "Quitter": "Quit", "Ouvrir funscript": "Open funscript", "Ouvrir dossier": "Open folder",
        "Créer depuis vidéo": "Create from video", "Aperçu": "Preview", "Appliquer": "Apply",
        "Traiter dossier": "Process folder", "Générer CockHero": "Generate CockHero",
        "Optimiser un funscript existant": "Optimize an existing funscript",
        "Détection": "Detection", "Amplitude": "Amplitude", "Mélange": "Mixing",
        "Cycles": "Cycles", "Début": "Start", "Transitions": "Transitions", "Fin": "End",
        "Génération": "Generation", "Épisodes": "Episodes", "Épisode": "Episode",
        "Patterns / Fin": "Patterns / End", "Paramètres de génération": "Generation settings",
        "Détection visuelle": "Visual detection", "Analyse": "Analysis", "Vidéos": "Videos",
        "Dossier": "Folder", "Nom": "Name", "Durée vidéo": "Video duration",
        "Prêt": "Ready", "Prête": "Ready", "Aucun fichier": "No file", "Aucune vidéo": "No video",
        "Enregistrer": "Save", "Fermer": "Close", "Annuler": "Cancel", "Supprimer": "Delete",
        "Verrouiller": "Lock", "Réanalyser (manuel)": "Reanalyze (manual)",
        "Traitement par lot": "Batch processing", "TRAITEMENT PAR LOT": "BATCH PROCESSING",
        "Créer / prévisualiser depuis la vidéo": "Create / preview from video",
        "Créer un funscript depuis une vidéo seule": "Create a funscript from video only",
        "Générer CockHero Visuel": "Generate Visual CockHero",
        "Générer depuis les franchissements": "Generate from crossings",
        "Logique de génération des marqueurs :": "Marker generation logic:",
        "Réglages de l'épisode sélectionné": "Selected episode settings",
        "Appliquer tous les réglages": "Apply all settings",
        "Appliquer Haut/Bas à tous les épisodes": "Apply High/Low to all episodes",
        "Appliquer la logique": "Apply logic", "Supprimer un épisode": "Delete an episode",
        "Supprimer le point le plus proche": "Delete nearest point", "Ajouter un point ici": "Add point here",
        "Mode : éditer les points": "Mode: edit points", "Mode : déplacer toute la trame": "Mode: shift entire track",
        "Mode : navigation vidéo": "Mode: video navigation", "Verrouiller la trame": "Lock track",
        "Montée progressive au début": "Progressive fade-in at start",
        "Descente progressive à la fin": "Progressive fade-out at end",
        "Patterns de fin de vidéo": "End-of-video patterns",
        "Patterns utilisés pour toute la vidéo": "Patterns used for the entire video",
        "Choisir aléatoirement parmi les patterns de fin sélectionnés": "Randomly choose among selected end patterns",
        "Utiliser les patterns sélectionnés dans les trous": "Use selected patterns in gaps",
        "Utiliser des patterns personnalisés jusqu'à la fin de la vidéo": "Use custom patterns until video end",
        "Aperçu automatique": "Automatic preview", "Détecter automatiquement le vrai début": "Automatically detect real start",
        "Retirer anciens blocs répétitifs": "Remove old repetitive blocks",
        "Mélanger cycle précédent / suivant": "Mix previous / next cycle",
        "Remplissage progressif du début": "Progressive start fill",
        "Adoucir le premier bloc original": "Smooth first original block",
        "Transitions douces dans les trous": "Smooth transitions in gaps",
        "Diminuer progressivement la fin": "Gradually fade the end",
        "Amplitude générale": "Overall amplitude", "Amplitude des trous": "Gap amplitude",
        "Minimum au centre du trou": "Minimum at gap center", "Amplitude minimale ajoutée": "Minimum added amplitude",
        "Part du cycle précédent": "Previous cycle share", "Recherche arrière (s)": "Lookback (s)",
        "Cycles récents à répéter": "Recent cycles to repeat", "Cycle minimum (ms)": "Minimum cycle (ms)",
        "Cycle maximum (ms)": "Maximum cycle (ms)", "Fenêtre source initiale (ms)": "Initial source window (ms)",
        "Amplitude fin du début": "End-of-start amplitude", "Pas initial très lent (ms)": "Very slow initial step (ms)",
        "Pas final (ms)": "Final step (ms)", "Rampe de vitesse (ms)": "Speed ramp (ms)",
        "Rampe premier bloc (ms)": "First block ramp (ms)", "Transition des trous (ms)": "Gap transition (ms)",
        "Amplitude finale": "Final amplitude", "Tolérance blocs répétitifs": "Repetitive block tolerance",
        "Points par hauteur": "Points per level", "Choisir la vidéo": "Choose video", "Choisir le dossier": "Choose folder",
        "Choisir une vidéo": "Choose a video", "Enregistrer le funscript": "Save funscript",
        "Enregistrer le nouveau .funscript": "Save new .funscript", "Enregistrer .funscript…": "Save .funscript…",
        "Ouvrir .funscript…": "Open .funscript…", "Vidéo…": "Video…", "Lot de vidéos…": "Video batch…",
        "Annuler l'analyse": "Cancel analysis", "Annuler sélection": "Clear selection",
        "Annuler après la vidéo actuelle": "Cancel after current video", "Détection automatique de la cible": "Automatic target detection",
        "Ignorer la moitié droite de la piste": "Ignore right half of track", "Inverser la phase depuis la fin (test seulement)": "Reverse phase from end (test only)",
        "Seuil différence pixel": "Pixel difference threshold", "Seuil récupération (x)": "Recovery threshold (x)",
        "Trou minimum à examiner (ms)": "Minimum gap to inspect (ms)", "Centre piste %": "Track center %",
        "Position cible finale 0..100": "Final target position 0..100", "Maintien final (ms)": "Final hold (ms)",
        "Force finale 0..1": "Final strength 0..1", "Descente fin (ms)": "End fade (ms)",
        "Amplitude fixe :": "Fixed amplitude:", "Nom :": "Name:", "Épisode :": "Episode:", "Mode :": "Mode:",
        "VIDÉO": "VIDEO", "FUNSCRIPT : aucun": "FUNSCRIPT: none", "VIDÉO : aucune": "VIDEO: none",
        "Ligne visuelle non analysée": "Visual line not analyzed", "Piste visuelle non analysée": "Visual track not analyzed",
        "Aucun indicateur visuel analysé": "No visual indicator analyzed",
    }

    _EN_WORDS = (
        ("Aucun", "No"), ("Aucune", "No"), ("aucun", "no"), ("aucune", "no"),
        ("fichier", "file"), ("Fichier", "File"), ("vidéo", "video"), ("Vidéo", "Video"),
        ("dossier", "folder"), ("Dossier", "Folder"), ("épisode", "episode"), ("Épisode", "Episode"),
        ("épisodes", "episodes"), ("Épisodes", "Episodes"), ("détection", "detection"), ("Détection", "Detection"),
        ("analyse", "analysis"), ("Analyse", "Analysis"), ("génération", "generation"), ("Génération", "Generation"),
        ("générer", "generate"), ("Générer", "Generate"), ("traitement", "processing"), ("Traitement", "Processing"),
        ("ouvrir", "open"), ("Ouvrir", "Open"), ("enregistrer", "save"), ("Enregistrer", "Save"),
        ("supprimer", "delete"), ("Supprimer", "Delete"), ("ajouter", "add"), ("Ajouter", "Add"),
        ("appliquer", "apply"), ("Appliquer", "Apply"), ("annuler", "cancel"), ("Annuler", "Cancel"),
        ("début", "start"), ("Début", "Start"), ("fin", "end"), ("Fin", "End"),
        ("durée", "duration"), ("Durée", "Duration"), ("seuil", "threshold"), ("Seuil", "Threshold"),
        ("ligne", "line"), ("Ligne", "Line"), ("visuelle", "visual"), ("visuel", "visual"), ("Visuel", "Visual"),
        ("points", "points"), ("point", "point"), ("trame", "track"), ("Trame", "Track"),
        ("déplacer", "shift"), ("modifier", "edit"), ("navigation", "navigation"), ("lecture", "playback"),
        ("droite", "right"), ("gauche", "left"), ("haut", "high"), ("bas", "low"),
        ("sélectionné", "selected"), ("sélectionnée", "selected"), ("sélectionner", "select"),
        ("progressive", "progressive"), ("progressivement", "gradually"), ("automatique", "automatic"),
        ("activer", "enable"), ("Activer", "Enable"), ("désactiver", "disable"),
        ("Prêt", "Ready"), ("Prête", "Ready"), ("Terminée", "Complete"), ("terminée", "complete"),
        ("Erreur", "Error"), ("Impossible", "Unable"), ("Paramètres", "Settings"), ("Réglages", "Settings"),
        ("correction", "correction"), ("Correspondances", "Matches"), ("Attente", "Waiting"),
        ("OUI", "YES"), ("NON", "NO"), ("Oui", "Yes"), ("Non", "No"),
    )

    def _translate_text(self, text):
        if self.language_var.get() != "English" or not isinstance(text, str):
            return text
        if text in self._EN_EXACT:
            return self._EN_EXACT[text]
        result = text
        for fr, en in self._EN_WORDS:
    ...
    def _change_language(self, _event=None):
        ...
        try:
            self.saved_config["language"] = self.language_var.get()
            self._save_app_config()
        except Exception:
            pass

    def _apply_language(self):
        """Switch visible UI text live without restarting the application."""
        english = self.language_var.get() == "English"
        self.language_label.configure(text="Language:" if english else "Langue :")
        self.title(
            f"CockHero Funscript Generator - {APP_VERSION}"
            if english else f"CockHero Funscript Generator - {APP_VERSION}"
        )

        def walk(widget):
            # Standard Tk/ttk text-bearing widgets.
            try:
                if not hasattr(widget, "_fr_text"):
                    widget._fr_text = widget.cget("text")
                widget.configure(text=self._translate_text(widget._fr_text) if english else widget._fr_text)
            except Exception:
                pass
            # Combobox values and Listbox entries (patterns/presets included).
            if isinstance(widget, ttk.Combobox) and widget is not self.language_combo:
                try:
                    if not hasattr(widget, "_fr_values"):
                        widget._fr_values = tuple(widget.cget("values"))
                    widget.configure(values=tuple(self._translate_text(v) for v in widget._fr_values) if english else widget._fr_values)
                except Exception:
                    pass
            if isinstance(widget, tk.Listbox):
                try:
                    if not hasattr(widget, "_fr_items"):
                        widget._fr_items = tuple(widget.get(0, tk.END))
                    selection = widget.curselection()
                    widget.delete(0, tk.END)
                    for item in widget._fr_items:
                        widget.insert(tk.END, self._translate_text(item) if english else item)
                    for i in selection:
            ...
            if isinstance(widget, ttk.Notebook):
                try:
                    if not hasattr(widget, "_fr_tabs"):
                        widget._fr_tabs = [widget.tab(tab, "text") for tab in widget.tabs()]
                    for tab, fr in zip(widget.tabs(), widget._fr_tabs):
                        widget.tab(tab, text=self._translate_text(fr) if english else fr)
                except Exception:
                    pass
            # Treeview headings.
            if isinstance(widget, ttk.Treeview):
                try:
                    cols = ("#0",) + tuple(widget.cget("columns"))
                    if not hasattr(widget, "_fr_headings"):
                        widget._fr_headings = {c: widget.heading(c).get("text", "") for c in cols}
                    for c, fr in widget._fr_headings.items():
                        widget.heading(c, text=self._translate_text(fr) if english else fr)
                except Exception:
                    pass
        ...
        # Tk menus are not children in the normal ttk hierarchy.
        def translate_menu(menu):
            ...
            if end is None:
                return
            if not hasattr(menu, "_fr_labels"):
                menu._fr_labels = {}
                for i in range(end + 1):
                    try:
                        if menu.type(i) != "separator":
                            menu._fr_labels[i] = menu.entrycget(i, "label")
                    except Exception:
                        pass
            for i, fr in menu._fr_labels.items():
                try:
                    menu.entryconfigure(i, label=self._translate_text(fr) if english else fr)
                    subname = menu.entrycget(i, "menu")
                    if subname:
                        translate_menu(menu.nametowidget(subname))
                except Exception:
                    pass

        try:
            translate_menu(self.nametowidget(self.cget("menu")))
        except Exception:
            pass
    ...
    def _build_ui(self):
        ...
        # v4.15.0 — language selector always visible at the top.
        self.language_combo = ttk.Combobox(
            top, textvariable=self.language_var,
            values=("Français", "English"), state="readonly", width=10
        )
        self.language_combo.pack(side="right", padx=(8, 4))
        self.language_combo.bind("<<ComboboxSelected>>", self._change_language)
        self.language_label = ttk.Label(top, text="Langue :", style="Toolbar.TLabel")
        ...
        # Canvas caché kept only for compatibility interne.
